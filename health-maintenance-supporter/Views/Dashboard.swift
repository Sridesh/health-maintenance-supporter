    ...
    var body: some View {
        VStack{
            ...
            VStack{
                ...
                HStack{
                    VStack{
                        IntakeIndicator(name: "Fat", intake: 12, fullAmount: 200).padding(.bottom)
                        IntakeIndicator(name: "Protein", intake: 12, fullAmount: 200).padding(.bottom)
                        IntakeIndicator(name: "Sodium", intake: 12, fullAmount: 200)
                    }.padding(.trailing)
                    
                    VStack{
                        IntakeIndicator(name: "Net Carbs", intake: 12, fullAmount: 200).padding(.bottom)
                        IntakeIndicator(name: "Fiber", intake: 12, fullAmount: 200).padding(.bottom)
                        IntakeIndicator(name: "Sugar", intake: 12, fullAmount: 200)
                    }.padding(.leading)
                }.padding(.top, 30)
                ...
                ScrollView{
                    VStack{
                        ForEach(mealsList) { meal in
                            FoodIntake(title: meal.title, icon: meal.image)
                        }
