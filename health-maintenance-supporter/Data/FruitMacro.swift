...
let fruitMacros: [FruitMacro] = [
    ...
    FruitMacro(id: 8, name: "Kiwi", carbs: 15.0, protein: 1.1, fat: 0.5, calories: 61,
               description: "Packed with vitamin C and fiber. Promotes digestion and supports skin health."),
    FruitMacro(id: 9, name: "Blueberry", carbs: 14.5, protein: 0.7, fat: 0.3, calories: 57,
               description: "Rich in antioxidants. Supports brain health and reduces oxidative stress."),
    FruitMacro(id: 10, name: "Watermelon", carbs: 8.0, protein: 0.6, fat: 0.2, calories: 30,
               description: "Hydrating fruit, rich in lycopene. Supports heart health and hydration."),
    FruitMacro(id: 11, name: "Dragon Fruit", carbs: 11.0, protein: 1.1, fat: 0.4, calories: 50,
               description: "High in fiber and vitamin C. Supports digestive health and boosts immunity.")
]
